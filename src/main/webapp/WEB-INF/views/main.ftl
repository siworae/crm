    ...
    <table style="padding: 5px" width="100%">
        <tr>
            ...
            <td valign="bottom" align="right" width="50%">
                <font size="3">&nbsp;&nbsp;<strong>欢迎：</strong>${(user.userName)!"sxt"}</font>【${(user.roleName)!"系统管理员" }】
            </td>
        </tr>
    </table>
</div>
...
<div id="dlg" class="easyui-dialog" style="width:400px;height:250px;padding: 10px 20px"
     closed="true" buttons="#dlg-buttons" title="修改密码" closable="false">
    ...
    <form id="fm" method="post">
        <table cellspacing="8px">
            ...
            <tr>
                <td>确认新密码：</td>
                <td><input type="password" id="confirmPassword" name="confirmPassword" class="easyui-validatebox"
                           required="true" style="width: 200px"/></td>
            </tr>
        </table>
    </form>
